...
def vestidos():
    query1 = text("""
        ...
        FROM clientes
        WHERE clientes.nombre_categoria = 'Vestidos'
    """)
    query2 = text("""
        SELECT productos.id_producto, productos.descripcion, productos.precio
        FROM productos
        WHERE productos.nombre_categoria = 'Vestidos'
    """)
    query3 = text("""
        SELECT empleados.id_empleado, empleados.nombre_empleado
        FROM empleados
        WHERE empleados.nombre_categoria = 'Vestidos'
    """)
    nombre_categoria = Categorias.query.distinct(Categorias.nombre_categoria).all()
    ...
    return render_template("vestidos.html", cliente=cliente, producto=producto, empleado=empleado,nombre_categoria=nombre_categoria)
...
def  ropa_interior():
    ...
    query1 = text("""
        SELECT clientes.id_cliente, clientes.nombre_cliente
        FROM clientes
        WHERE clientes.nombre_categoria = 'Ropa Interior'
    """)
    query2 = text("""
        SELECT productos.id_producto, productos.descripcion, productos.precio
        FROM productos
        WHERE productos.nombre_categoria = 'Ropa Interior'
    """)
    query3 = text("""
        SELECT empleados.id_empleado, empleados.nombre_empleado
        FROM empleados
    ...
    try:
        ...
        producto = []  
        empleado = []
    return render_template("ropa_interior.html", cliente=cliente, producto=producto, empleado=empleado)
...
def  jeans():
    query1 = text("""
        SELECT clientes.id_cliente, clientes.nombre_cliente
        FROM clientes
        WHERE clientes.nombre_categoria = 'Jeans'
    """)
    query2 = text("""
        SELECT productos.id_producto, productos.descripcion, productos.precio
        FROM productos
        WHERE productos.nombre_categoria = 'Jeans'
    """)
    query3 = text("""
        SELECT empleados.id_empleado, empleados.nombre_empleado
        FROM empleados
        WHERE empleados.nombre_categoria = 'Jeans'
    """)
    ...
    try:
        ...
        producto = []  
        empleado = []
    return render_template("jeans.html", cliente=cliente, producto=producto, empleado=empleado)
...
def  camisas():
    query1 = text("""
        SELECT clientes.id_cliente, clientes.nombre_cliente
        FROM clientes
        WHERE clientes.nombre_categoria = 'Camisas'
    """)
    query2 = text("""
        SELECT productos.id_producto, productos.descripcion, productos.precio
        FROM productos
        WHERE productos.nombre_categoria = 'Camisas'
    """)
    query3 = text("""
        SELECT empleados.id_empleado, empleados.nombre_empleado
        FROM empleados
        WHERE empleados.nombre_categoria = 'Camisas'
    """)
    ...
    try:
        ...
        producto = []  
        empleado = []
    return render_template("camisas.html", cliente=cliente, producto=producto, empleado=empleado)
